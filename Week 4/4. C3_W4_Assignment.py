...
def train_model(Siamese, TripletLoss
    ...
    train_task = training.TrainTask( 
        ...
        lr_schedule=trax.lr.warmup_and_rsqrt_decay(400, 0.01),  # Trax multifactor schedule function
    )
...
def classify(test_Q1, test_Q2, y, threshold, model, vocab, data_generator=data_generator, batch_size=64):
    ...
    for i in range(0, len(test_Q1), batch_size):
        ...
        q1, q2 = next(data_generator(test_Q1[i:i+batch_size],test_Q2[i:i+batch_size],batch_size,vocab['<PAD>'],shuffle=None))
